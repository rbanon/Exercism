...
# Implement the function is_criticality_balanced()
# that takes temperature and neutrons_emitted as parameters
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    """
    safe_test = temperature * neutrons_produced_per_second
    if safe_test < threshold*0.9:
        return "LOW"
    if (threshold*0.9)<= safe_test <=(threshold*1.1):
        return "NORMAL"
    return "DANGER"
